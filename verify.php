...
if(isset($_POST['verify'])){
  $token = $_POST['token'];
  $verifyToken = dekripsi(preg_replace("/[^A-Za-z]/", "", $_SESSION['password']), -7);
        ...
        <div class="card" >
          ...
          <div class="card-body">
            <form method="post">
              ...
              <div class="mb-3">
                <span>
                  Masukkan token yang anda dapat agar dapat mendaftar dan memsukkan nilai pada laman PPDB SMAN 5 SURAKARTA.
                </span>
              </div>
              <div class="mb-3">
